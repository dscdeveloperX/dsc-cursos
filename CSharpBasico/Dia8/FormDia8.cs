...
namespace CSharpBasico.Dia8
{
    public partial class FormDia8 : Form
    {
      ...
      private  string cadenaConexion = @"Data source=DSC-PC\ISQL; Initial Catalog=darwincito_db; Integrated Security=True; Password=son200420052012";
        ...
        private void SelectPersona3()
        {
            //cadena de conexion
            string cadenaConexion = @"Data source=SQL2012.dbsqlserver.com,1288; Initial Catalog=facefocu_principal; User ID=facefocu_user; Password=S@n200420052012";
            ...
            //(a) establecido la clase conexion
            //(b) establecido tipo de comando que es igual a un tipo "SP"
            SqlCommand cmd = new SqlCommand("update ciudad set ciudad_nombre = 'Azuay' where ciudad_id = 1; ", cnn);//(a)
            //cmd.CommandType = CommandType.StoredProcedure;//(b)
        ...
        private void SelectPersona2(string es, decimal sld)
        {
            //cadena de conexion
